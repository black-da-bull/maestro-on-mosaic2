...
> Song family: **rb v2.** · generation #4 in family · created 2025-08-17T02:30:57.130Z

## Metadata

- song_id: `42fd83f4-e4c3-404a-addc-f88a7975cd34`
- id: `2682872`
- model: `V4.5`
- created_at: `2025-08-17T02:30:57.130Z`
- updated_at: `2025-08-17T02:32:58.998Z`
- duration: `166.92`
- is_delete: `False`
- is_public: `True`
...
- audio_url: https://file.aisonggenerator.ai/d1b6e63f-4bd2-40fb-bee1-9094e7dee428.mp3
- wav_url: —
- cover_url: https://file.aisonggenerator.ai/ae58ca22-2826-4c2f-b3bd-f5d81b76356d.jpg
- vocal_url: —
- instrumental_url: —
- pipe_url: https://mfile.erweima.ai/NDJmZDgzZjQtZTRjMy00MDRhLWFkZGMtZjg4YTc5NzVjZDM0

## Style / Prompt (tags)

```
In a neon-lit juke joint deep in the southern night
a smoky contralto voice confesses over swirling ambient pads and whispering 808s. The song opens with DJ MoMoney calling out to boss chicks
as the filtered vocals creep in with a slow
sub-heavy rise. The verse glides into a smooth R&B bounce
where deep bass gl
The journey begins with an intimate
whispered intro over ambient pads
sub-bass
and sparse
cracking trap hi-hats. Testimony I introduces a rhythmic flow with tight 808 kick/snare
banjo loop
and subtle synth chords
maintaining a luxury bounce. Testimony II builds power with heavy 808s and lush gospel pads
featuring a pronounced southern vocal drawl. The Ancestral Bridge swells with a falsetto lead
rich gospel harmonies
pedal steel
and church organ. A raw
vulnerable spoken-word confessional unfolds over a lo-fi banjo loop. The release section explodes with dual female harmonies
full power vocals
chopped gospel samples
and high-energy trap fusion. The outro fades.
```
