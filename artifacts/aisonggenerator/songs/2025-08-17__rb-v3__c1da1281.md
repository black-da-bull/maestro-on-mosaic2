...
> Song family: **rb v** · generation #8 in family · created 2025-08-17T02:45:49.055Z

## Metadata

- song_id: `c1da1281-4771-4f8f-aa0f-09679ceb1141`
- id: `2683041`
- model: `V4.5`
- created_at: `2025-08-17T02:45:49.055Z`
- updated_at: `2025-08-17T02:47:27.883Z`
- duration: `164.80`
- is_delete: `False`
- is_public: `True`
...
- audio_url: https://file.aisonggenerator.ai/092a0e3a-f021-4ab8-9b3b-cd75c0ebde23.mp3
- wav_url: —
- cover_url: https://file.aisonggenerator.ai/7776687a-8377-456c-afdf-e54548025da5.jpg
- vocal_url: —
- instrumental_url: —
- pipe_url: https://mfile.erweima.ai/YzFkYTEyODEtNDc3MS00ZjhmLWFhMGYtMDk2NzljZWIxMTQx

## Style / Prompt (tags)

```
This is a groundbreaking Southern Soul/DANCEHALL TRAP blend; meticulously crafted with a cinematic and layered production aesthetic; the track begins as a lo‑fi tape acoustic session with raw analog grit: a resonant upright bass and a bluesy acoustic guitar and brushed drums are underpinned by syncopated tribal percussion and an infectious highlife/Afrobeat feel; the mix maintains dynamic rhythm and dynamic contrasts; verses are intimate and emotionally intense duets with a call‑and‑response between a gritty male vocalist (rudeboi) and a deep contralto female vocalist (rudegirl); her performance is rich with AAVN and microtonal riffs and vocal fry expressing raw emotion; a subtle disco groove anchors the pocket and establishes a relentless club beat at 110 BPM; the chorus marks a dramatic tension release swelling with analog warmth and punchy keys and lush and rich gospel pads; a soaring female choir and a powerful chord progression elevate the melodies; the final studio production
```
