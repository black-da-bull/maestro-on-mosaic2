...
# MoMoney Knowledge Spine (v3.1.2)

Authoritative creative/technical guidance the model must treat as house rules.

## UST Canon


- Immutable macro order; explicit section headers; narrative transitions; specify delivery/phrasing; protect lyric uniqueness via metadata elevation.

## Mix & Performance Heuristics


- Dark plate on hooks; mono kick/sub; phone scene **mono band-pass 200–5 kHz**; preserve outro; mastering headroom.

## Language & Prosody


- Scansion first; chant scannability for multilingual phrases; UTF-8 normalization; lines ≤120 chars.

## Governance


- SME roles; ejection rule; consensus threshold 0.85; V&V phases; telemetry schema adherence.

## Compression Patterns


- Move repeated descriptions to Style/Timbre/Performance; replace safe hook repeats with `(repeat)`; keep lyrics unique.
